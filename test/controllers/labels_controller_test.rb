...
class LabelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create label" do
    assert_difference('Label.count') do
      post labels_url, params: { label: { category_id: @label.category_id, labelled_at: @label.labelled_at, text_id: @label.text_id } }
    end
  ...
  test "should update label" do
    patch label_url(@label), params: { label: { category_id: @label.category_id, labelled_at: @label.labelled_at, text_id: @label.text_id } }
